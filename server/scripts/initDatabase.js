...
async function initialize() {
    try {
        ...
        run(`INSERT OR IGNORE INTO users (username, password, real_name, role, phone, email) VALUES (?, ?, ?, ?, ?, ?)`, 
            ['admin', hashedPassword, '系统管理员', 'admin', '13800000001', 'admin@example.com']);
        run(`INSERT OR IGNORE INTO users (username, password, real_name, role, phone, email) VALUES (?, ?, ?, ?, ?, ?)`, 
            ['doctor_zhang', hashedPassword, '张医生', 'doctor', '13800000002', 'zhang@example.com']);
        run(`INSERT OR IGNORE INTO users (username, password, real_name, role, phone, email) VALUES (?, ?, ?, ?, ?, ?)`, 
            ['nurse_li', hashedPassword, '李护士', 'nurse', '13800000003', 'li@example.com']);
        run(`INSERT OR IGNORE INTO users (username, password, real_name, role, phone, email) VALUES (?, ?, ?, ?, ?, ?)`, 
            ['service_wang', hashedPassword, '王客服', 'service', '13800000004', 'wang@example.com']);
        ...
        run(`INSERT OR IGNORE INTO elderly (name, gender, birth_date, phone, address, emergency_contact, emergency_phone, health_status, risk_level, chronic_diseases, device_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
            ['王大爷', '男', '1945-03-15', '13900000001', '幸福社区A栋1单元101', '王小明', '13900000011', '一般', '中风险', '高血压、糖尿病', 'DEV001']);
        run(`INSERT OR IGNORE INTO elderly (name, gender, birth_date, phone, address, emergency_contact, emergency_phone, health_status, risk_level, chronic_diseases, device_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
            ['李奶奶', '女', '1948-07-22', '13900000002', '幸福社区B栋2单元302', '李小红', '13900000012', '良好', '低风险', '无', 'DEV002']);
        run(`INSERT OR IGNORE INTO elderly (name, gender, birth_date, phone, address, emergency_contact, emergency_phone, health_status, risk_level, chronic_diseases, device_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
            ['张大爷', '男', '1942-11-08', '13900000003', '幸福社区C栋3单元501', '张小刚', '13900000013', '较差', '高风险', '心脏病、高血压', 'DEV003']);
        run(`INSERT OR IGNORE INTO elderly (name, gender, birth_date, phone, address, emergency_contact, emergency_phone, health_status, risk_level, chronic_diseases, device_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
            ['赵奶奶', '女', '1950-05-30', '13900000004', '幸福社区A栋2单元201', '赵小芳', '13900000014', '健康', '低风险', '无', 'DEV004']);
        run(`INSERT OR IGNORE INTO elderly (name, gender, birth_date, phone, address, emergency_contact, emergency_phone, health_status, risk_level, chronic_diseases, device_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, 
            ['刘大爷', '男', '1946-09-12', '13900000005', '幸福社区B栋1单元402', '刘小华', '13900000015', '一般', '中风险', '关节炎', 'DEV005']);
        
        run(`INSERT OR IGNORE INTO doctors (name, gender, phone, specialization, hospital, status, rating) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            ['张伟', '男', '13811111111', '内科', '社区医院', '在线', 4.8]);
        run(`INSERT OR IGNORE INTO doctors (name, gender, phone, specialization, hospital, status, rating) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            ['李芳', '女', '13811111112', '心血管科', '社区医院', '在线', 4.9]);
        run(`INSERT OR IGNORE INTO doctors (name, gender, phone, specialization, hospital, status, rating) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            ['王强', '男', '13811111113', '急诊科', '社区医院', '忙碌', 4.7]);
        run(`INSERT OR IGNORE INTO doctors (name, gender, phone, specialization, hospital, status, rating) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            ['陈静', '女', '13811111114', '老年科', '社区医院', '离线', 4.6]);
        ...
        run(`INSERT OR IGNORE INTO alerts (elderly_id, alert_type, alert_level, title, content, location, status) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            [3, '紧急', 1, '张大爷心率异常', '心率高达120次/分钟，请立即处理', '幸福社区C栋3单元501', '待处理']);
        run(`INSERT OR IGNORE INTO alerts (elderly_id, alert_type, alert_level, title, content, location, status) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            [1, '警告', 2, '王大爷血压偏高', '血压158/95 mmHg，建议关注', '幸福社区A栋1单元101', '待处理']);
        run(`INSERT OR IGNORE INTO alerts (elderly_id, alert_type, alert_level, title, content, location, status) VALUES (?, ?, ?, ?, ?, ?, ?)`, 
            [2, '提醒', 3, '李奶奶服药提醒', '下午3点需服用降压药', '幸福社区B栋2单元302', '已处理']);
        ...
        console.log('  医生: doctor_zhang');
        console.log('  护理员: nurse_li');
        console.log('  客服: service_wang');
        console.log('');
